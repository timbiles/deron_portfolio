  ...
  <div className="library_carousel">
    ...
    >
      <Slider>
        ...
        <Slide index={3}>
        <a target='_blank' href="https://theologicalmatters.com/2014/10/20/theological-tailgating/">
        ...
        <Slide index={4}>
        <a target='_blank' href="https://theologicalmatters.com/2014/09/30/worthy-of-double-honor/">
        ...
        <Slide index={5}>
        <a target='_blank' href="https://theologicalmatters.com/2014/08/25/pastors-and-rookie-mistakes/">
